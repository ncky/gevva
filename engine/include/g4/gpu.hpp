...
inline constexpr char kTargetPciBusId[] = "0000:0f:00.0";
inline constexpr int kTargetComputeMajor = 12;
inline constexpr int kTargetComputeMinor = 0;
inline constexpr std::size_t kMinimumTargetVram = 90ULL << 30;
...
// Finds the card by physical PCI address, selects it, then verifies the exact
// architecture and memory class. This stays correct when CUDA ordinals change.
